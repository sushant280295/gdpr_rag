...
class OnlineServices(Document):
    def __init__(self, path_to_manual_as_csv_file = "./inputs/documents/online_services.parquet"):
        ...
        if not self.check_columns():
            raise AttributeError(f"The input parquet file for the Online Services class does not have the correct column headings")
