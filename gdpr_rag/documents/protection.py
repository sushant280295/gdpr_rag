...
class Protection(Document):
    def __init__(self, path_to_manual_as_csv_file = "./inputs/documents/protection.parquet"):
        ...
        if not self.check_columns():
            raise AttributeError(f"The input parquet file for the Protection class does not have the correct column headings")
